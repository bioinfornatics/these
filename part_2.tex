...
\begin{itemize}
	\item \texttt{grools-application}l'exploration du métabolisme à travers les modèles GenomeProperties et UniPathway  (\url{https://github.com/Grools/grools-application}).
