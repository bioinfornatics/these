...
C’est pourquoi (répétition) tant les prédictions informatiques que les hypothèses émises par l’Homme doivent être vérifiées par une approche expérimentale. Afin de minimiser le nombre d’expérimentation, est-il possible de valider empiriquement plusieurs prédictions à partir d’une expectation ?
