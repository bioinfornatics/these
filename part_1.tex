\begin{refsegment}
    ...
    \begin{table}
        ...
        \begin{tabular}{p{0.2\linewidth}|p{0.3\linewidth}|p{0.5\linewidth}}
            ...
            \midrule
            Biologies des systèmes  & \href{http://www.genome.jp/kegg/pathway.html}{KEGG PATHWAY}           & Carte métabolique \\   
            \cline{2-3}
            ...
            \cline{2-3}             & \href{http://www.genome.jp/kegg/glycan/}{KEGG GLYCAN}                 &\\
            \cline{2-3}             & \href{http://www.genome.jp/kegg/reaction/}{KEGG REACTION}             &\\
            \cline{2-3}             & \href{http://www.genome.jp/kegg/annotation/enzyme.html}{KEGG ENZYME}  &\\
            \hline
            Santé                   & \href{http://www.genome.jp/kegg/disease/}{KEGG DISEASE}               & \\
            \cline{2-3}             & \href{http://www.genome.jp/kegg/drug/}{KEGG DRUG}                     &\\
            \cline{2-3}             & \href{http://www.genome.jp/kegg/drug/environ.html}{KEGG ENVIRON}      &\\
            \cline{2-3}             & \href{http://www.genome.jp/kegg/medicus.html}{KEGG MEDICUS}           &\\
            \bottomrule
        \end{tabular}
    \end{table}
    ...
    \begin{shadedfigure}
        \centering
        \includegraphics[width=\textwidth]{img/seven_genralized_truth_values.pdf}
        \caption{  }
        \label{fig:seven_truth_values}
    \end{shadedfigure}
    \begin{shadedfigure}
        \centering
        \includegraphics[width=\textwidth]{img/Generalized_Truth_Values_and_Multilattices.pdf}
        \caption{  }
