\begin{refsegment}
    ...
    \begin{shadedfigure}[H]
        \centering
        \includegraphics[width=\textheight]{img/lysine_biosynthesis_1_metacyc.png}
...
%        \includegraphics[width=\textwidth]{img/glycolysis.png}
    ...
    La logique met en relation des éléments autour d'une conjonction ou d'une disjonction. Ce tout forme une clause logique composé d'au moins deux littéraux et d'un connecteur (i.e $p \land q$ ).
