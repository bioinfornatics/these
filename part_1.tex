\begin{refsegment}
    ...
    \note{
    	Selon le fournisseur d'internet néo-zélandais "\textit{Actrix}":
    	\begin{itemize}
    		\item 60\% des compagnies ayant perdu toutes leurs données ont fermé dans les 6 mois après l'évènement.
    		\item Il est estimé pour une heure de donnée perdue, coûte en moyenne à une entreprise 790\$.
