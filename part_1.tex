\begin{refsegment}
    ...
    \subsection{Méthodes utilisant des logiques probabilistes}
    
    Il existe également des méthodes basé sur la fouille de données pour émettre des lois générale avec un certains niveau de confiance au regard de nos connaissance actuelle. 
