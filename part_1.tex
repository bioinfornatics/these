\begin{refsegment}
    ...
    Dans le domaine de la biologie et plus précisément sur l'annotation des gènes, il existe plusieurs méthodologie. Ce qui nous amène à présenter HAMAP, UniRule, Genome properties et IMG terms. Comme expliqué par \citeauthor{dale2010machine}\cite{dale2010machine} il ne faut pas perdre le point de vue suivant, l'annotation des gènes est essentiel pour étudier le réactome d'un organisme.
    
    \subsection{UniRule}
    Dans l'objectif de mimer l'expertise humaine sur l'annotation de plusieurs milliard de séquence, UniProt à mis en place un outil à base de règle appelé UniRule \cite{unirule2015,bridge2010unirule}.
    
    \begin{shadedfigure}
        \centering
        \includegraphics[width=\textwidth]{img/unirule.png}
        \caption{ Chaînage d'apllication pour l'annotation automatique pour la base de donnée UniProtKB. Figure extraite de \citetitle{bridge2010unirule}. }
        \label{fig:unirule}
    \end{shadedfigure}
